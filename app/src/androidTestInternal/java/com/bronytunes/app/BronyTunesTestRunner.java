...
public final class BronyTunesTestRunner extends AndroidJUnitRunner {
    private PowerManager.WakeLock wakeLock;

    @Override
    public void onStart() {
        // Inform the app we are an instrumentation test before the object graph is initialized.
        DebugBronyTunesModule.instrumentationTest = true;

        Context app = getTargetContext().getApplicationContext();

        String name = BronyTunesTestRunner.class.getSimpleName();
