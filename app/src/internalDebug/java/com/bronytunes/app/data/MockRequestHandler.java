...
public class MockRequestHandler extends RequestHandler {
    ...
    public Result load(Request request, int networkPolicy) throws IOException {
        ...
        // If we got this far there was a cache miss and hitting the network is requried. See if we need
        // to fake a network error.
        ...
        // Grab the new image stream and return it.
